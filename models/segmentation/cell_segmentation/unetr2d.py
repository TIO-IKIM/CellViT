# -*- coding: utf-8 -*-
# UNETR2d networks and adaptions
#
...
from .utils import ViTUNETR2d, ViTUNETR2dDeit
...
class UNETR2d(nn.Module):
    """UNETR2d Modell for cell segmentation. U-Net like network with vision transformer as backbone encoder
...
class UNETR2dVIT256(UNETR2d):
    """UNETR2d with ViT-256 backbone settings (https://github.com/mahmoodlab/HIPT/blob/master/HIPT_4K/Checkpoints/vit256_small_dino.pth)
...
class UNETR2dUnshared(UNETR2d, nn.Module):
    def __init__(
        self,
        num_nuclei_classes: int,
        num_tissue_classes: int,
...
class UNETR2dVIT256Unshared(UNETR2dUnshared):
    """UNETR2d with ViT-256 backbone settings (https://github.com/mahmoodlab/HIPT/blob/master/HIPT_4K/Checkpoints/vit256_small_dino.pth)
...
class UNETR2dSAM(UNETR2d):
    """UNETR2d with SAM backbone settings
...
class UNETR2dSAMUnshared(UNETR2dUnshared):
    """UNETR2d with SAM backbone settings
