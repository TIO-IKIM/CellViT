...
class CellViTCPPTrainer(CellViTTrainer):
    ...
    def calculate_loss(
        self, predictions: DataclassCPPStorage, gt: DataclassCPPStorage
    ) -> torch.Tensor:
        """Calculate the loss

        Args:
            predictions (DataclassCPPStorage): Processed network output
            gt (DataclassCPPStorage): Ground truth values
