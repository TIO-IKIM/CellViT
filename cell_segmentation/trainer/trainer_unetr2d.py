...
from models.segmentation.cell_segmentation.unetr2d import UNETR2d
from utils.tools import AverageMeter


class UNETR2dTrainer(BaseTrainer):
    """UNETR2d trainer class

    Args:
        model (UNETR2d): UNETR2d model that should be trained
